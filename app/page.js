...
import { AppBar, Box, Button, Container, Dialog, DialogActions, DialogContent, DialogContentText, DialogTitle, Grid, TextField, Toolbar, Typography } from "@mui/material";
  ...
  return (
    <Container maxWidth='100vw'>
      ...
      <Box sx={{
        ...
        <Button variant='containted' color='primary' sx={{ mt: 2 }}>
          Get Started
        </Button>
      </Box>
